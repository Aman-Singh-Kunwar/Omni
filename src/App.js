...
const ServiceMarketplaceLanding = () => {
  ...
  const handleLogin = () => {
    ...
    setCurrentPage(selectedUserType);
    setShowLoginModal(false);
    setSelectedUserType(null);
  };

  // Simple Customer Dashboard Component
  const CustomerDashboard = () => (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Welcome back, Customer!</h2>
  ...
  // Simple Broker Dashboard Component
  const BrokerDashboard = () => (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Broker Dashboard</h2>
            <p className="text-gray-600">Manage your network and earn commissions</p>
          </div>
          <button 
            onClick={() => setCurrentPage('home')}
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-3xl font-bold text-green-600">₹25,450</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm">
  ...
  // Simple Worker Dashboard Component
  ...
  if (currentPage === 'customer') return <CustomerDashboard />;
  if (currentPage === 'broker') return <BrokerDashboard />;
  if (currentPage === 'worker') return <WorkerDashboard />;
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-5xl font-bold text-gray-900 mb-6">
            Your Trusted <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Service Marketplace</span>
          </h2>
