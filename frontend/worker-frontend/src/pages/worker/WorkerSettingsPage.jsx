...
const ROLE_SESSION_KEY = "omni_worker_session";
...
function WorkerSettingsPage({ onLogout, authToken, userName = "", userEmail = "" }) {
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div ref={notificationsSectionRef} className="border rounded-lg p-6 bg-white/60">
          ...
          <NotificationSettingsSection
            ...
            labels={{
              jobRequests: { title: "New Job Requests", description: "Get notified immediately for new job requests from customers." },
              payments: { title: "Earnings Updates", description: "Get alerts when payment is credited to your account." },
              jobAlerts: { title: "Schedule Alerts", description: "Receive reminders for upcoming jobs and travel time." },
              reminders: { title: "Account Reminders", description: "Get reminders to update profile or verify information." }
            }}
          />
        </div>
