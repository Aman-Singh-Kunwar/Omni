      ...
      <div className="space-y-6 max-w-2xl mx-auto">
        <div className="border rounded-lg p-6 bg-white/60">
          ...
          <NotificationSettingsSection
            ...
            labels={{
              jobRequests: "Get notified for new or updated job requests.",
              payments: "Get alerts when payment is completed or updated.",
              jobAlerts: "Receive reminders for upcoming and active jobs.",
              reminders: "Receive extra reminders for pending actions."
            }}
          />
        </div>
