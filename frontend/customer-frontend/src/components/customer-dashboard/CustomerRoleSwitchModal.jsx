...
function CustomerRoleSwitchModal({ open, status, onRoleSwitch, onClose }) {
  if (!open) {
    return null;
  }
      ...
      <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-md w-full ui-modal-surface">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={status.loading}
            className="w-full p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-colors text-left ui-touch-target"
          >
            <div className="flex items-center space-x-3">
...
export default CustomerRoleSwitchModal;
