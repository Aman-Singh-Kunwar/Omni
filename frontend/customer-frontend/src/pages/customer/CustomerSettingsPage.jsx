...
const NOTIFICATION_STORAGE_KEY = "omni:settings:customer:notifications";
const ROLE_SESSION_KEY = "omni_customer_session";
...
function CustomerSettingsPage({ onLogout, authToken, userName = "", userEmail = "" }) {
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div ref={notificationsSectionRef} className="border rounded-lg p-6 bg-white/60">
          ...
          <NotificationSettingsSection
            ...
            labels={{
              jobRequests: { title: "Booking Updates", description: "Get notified when your service booking is confirmed or updated." },
              payments: { title: "Payment Receipts", description: "Get alerts when your payments are processed successfully." },
              jobAlerts: { title: "Service Alerts", description: "Receive reminders & tracking for your upcoming services." },
              reminders: { title: "Promotions & Reminders", description: "Receive personalized offers and account reminders." }
            }}
          />
        </div>
