    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Connect with skilled professionals for all your service needs. Fast, reliable, and secure service booking at your fingertips.
          </p>
            ...
            {userTypes.map((type) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="text-2xl font-bold text-gray-900 text-center mb-4">{type.title}</h4>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">Professional services for every need</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-gray-300 text-sm text-center md:text-left">
                Your trusted platform for connecting with skilled professionals. Fast, reliable, and secure service booking.
              </p>
              <div className="flex items-center space-x-1 text-gray-400 mt-4">
